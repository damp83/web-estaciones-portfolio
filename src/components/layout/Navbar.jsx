...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <header className="relative z-50 px-4 sm:px-6 lg:px-8 pt-6 pb-2">
      ...
      <div className={`hidden md:flex justify-center sticky top-6 z-[60] px-4 transition-all duration-500 pointer-events-none`}>
